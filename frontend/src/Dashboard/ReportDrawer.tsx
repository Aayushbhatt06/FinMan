...
/** Bottom sheet drawer for downloading a monthly statement (demo only). */
const ReportDrawer = ({ open, onClose }: ReportDrawerProps) => {
  ...
  const handleDownload = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.success(`Report for ${months[month - 1]} ${year} downloaded!`);
      onClose();
    }, 1500);
  };
